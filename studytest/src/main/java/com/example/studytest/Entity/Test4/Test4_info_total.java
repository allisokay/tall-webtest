...
//    private String word_rate;
    ...
    private String[] sentence_array;
    private String[] sentence_rate_array;
    private String[] rt;
    ...
    public String[] getSentence_array() {
        return sentence_array;
    }

    public void setSentence_array(String[] sentence_array) {
        this.sentence_array = sentence_array;
    }

    public String[] getSentence_rate_array() {
        return sentence_rate_array;
    }

    public void setSentence_rate_array(String[] sentence_rate_array) {
        this.sentence_rate_array = sentence_rate_array;
    }
    ...
    public String toString() {
        return "Test4_info_total{" +
                "part_email='" + part_email + '\'' +
                ", number=" + number +
                ", trial_index='" + trial_index + '\'' +
                ", trial_type='" + trial_type + '\'' +
                ", exp_type='" + exp_type + '\'' +
                ", user_answer=" + Arrays.toString(user_answer) +
                ", correct_answer=" + correct_answer +
                ", letter='" + letter + '\'' +
                ", letter_rate='" + letter_rate + '\'' +
                ", sentence='" + sentence + '\'' +
                ", sentence_rate='" + sentence_rate + '\'' +
                ", sentence_array=" + Arrays.toString(sentence_array) +
                ", sentence_rate_array=" + Arrays.toString(sentence_rate_array) +
