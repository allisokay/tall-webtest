...
export default {
        ...
        data() {
            return {
                ...
                test4_audio_02:[
                    require("../../../assets/static/test4/newAudio/Instruction_03.mp3"),
                    require("../../../assets/static/test4/newAudio/Instruction_04.mp3"),
                ],
                show: true,
                audios:[],
                audio:'',
        ...
        created() {
            for (let i = 0; i < this.test4_audio_02.length; i++) {
                this.audios[i] = this.test4_audio_02[i]
            }
            //播放音频
            this.order_play();
