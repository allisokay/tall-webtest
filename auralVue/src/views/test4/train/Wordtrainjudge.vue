    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="center">
                ...
                <div class="row">
                    <el-row>
                        <el-button class="normal" @click="click_space" :disabled="show">空格</el-button>
                    </el-row>
                    <div>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.current_group = GLOBAL.part1_test_length - GLOBAL.train_word_des.length;
        ...
        methods: {
            ...
            submit() {
                ...
                //计算正确的个数
                GLOBAL.user_right_w += this.correct_letter(this.check_array, this.actual_array);
                this.save();
                //如果听完了单词
