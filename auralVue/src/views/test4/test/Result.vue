    ...
    export default {
        ...
        methods: {
            ...
            save() {
                ...
                GLOBAL.number += content.rt.length;
                GLOBAL.trial_index++;
