...
<script>
    ...
    export default {
        ...
        methods:{
            order_play(){
                if(GLOBAL.test2_study1_audio5.length===0){
                    this.$router.push('/test2study6')
                }
                else{
                    if(GLOBAL.test2_study1_audio5.length===6)
                    {
                        this.image1=document.getElementById("image1")
                        this.img_show1(this.image1)
                        this.img1=true
                    }
                    if(GLOBAL.test2_study1_audio5.length===5)
                    {
                    ...
                    if(GLOBAL.test2_study1_audio5.length===4)
                    {
                    ...
                    if(GLOBAL.test2_study1_audio5.length===3)
                    {
                    ...
                    if(GLOBAL.test2_study1_audio5.length===2)
                    {
                    ...
                    if(GLOBAL.test2_study1_audio5.length===1)
                    {
                    ...
                    this.$forceUpdate();
                    let music=new Audio(GLOBAL.test2_study1_audio5.shift())
