...
<script>
    ...
    export default {
        ...
        methods:{
            order_play() {
                switch (GLOBAL.test2_audio3.length) {
                    case 0:
                        setTimeout(()=>{this.$router.push('/test2study4')}, 2000)
                        break
                    case 3:
                ...
                let music=new Audio(GLOBAL.test2_audio3.shift())
                music.addEventListener('ended', ()=>{this.order_play()})
                if (GLOBAL.test2_audio3.length===3 || GLOBAL.test2_audio3.length===2) {
                    music.play()
                } else {
