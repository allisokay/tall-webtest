<template>
    <div class="container">
        <div class="header">
          <h1 class="el-row"> 外语学能测试（文字版1）<br />
            TALL ( Written Version 1)
          </h1>
        </div>
        <div class="content">
            <div class="leftbound">
            ...
            <div class="left">
                ...
                <div class="el-row1">
                    <div class="normal">受邀测试人（第二次测试）<br><br>
                        Participant for the 2nd test
                    </div>
                </div>
                <div class="el-row1">
                    <div class="normal">普通访问者
                        Vistor
                    </div>
                </div>
            ...
            <div class="center">
                ...
                <!--    ]"-->
                <!--                                >-->
                <!--                                    <el-input v-model="form.email" placeholder="请填写邮箱作为登录名"></el-input>-->
                <!--                                </el-form-item>-->
                <!--                            </div>-->
                <!--                        </div>-->
                <!--                        <div class="row">-->
                <!--                            <div>-->
                <!--                                <el-form-item label="邀请码" label-position="right" >-->
                <!--                                    <el-input v-model="form.invited_code" placeholder="请输入邀请码（选填）"></el-input>-->
                <!--                                </el-form-item>-->
            ...
            <div class="right">
                <div class="el-row2">
                    <el-button type="primary" :disabled="false" @click="first_enter">进入(Enter)</el-button>
                </div>
                <div class="el-row2">
                    <el-button type="primary" :disabled="false" @click="second_enter">进入(Enter)</el-button>

                </div>
                <div class="el-row2">
                    <el-button type="primary" :disabled="true" @click="visitor_enter">进入(Enter)</el-button>
                </div>
            </div>
            <div class="leftbound">
                ...
                axios.get('invite/findByCode' + this.invited_code).then(function (resp) {
                    ...
                    if (resp.data) {
                       ...
                       //如果code的sesesions属性为W
                           ...
                           _this.$alert('该邀请码为视听版的邀请码！请输入文字版的邀请码', '提示', {
                               confirmButtonText: '确定',
                           });
