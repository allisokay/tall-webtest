...
<script>
    ...
    export default {
        ...
        methods: {
            order_play() {
                switch (GLOBAL.test2_audio2.length) {
                    case 0:
                        setTimeout(()=>{this.$router.push('/test2study3')}, 2000)
                        break
                    case 3:
                ...
                let music = new Audio(GLOBAL.test2_audio2.shift())
                music.addEventListener('ended', ()=>{this.order_play()})
                if (GLOBAL.test2_audio2.length===3 || GLOBAL.test2_audio2.length===2) {
                    music.play()
                } else {
